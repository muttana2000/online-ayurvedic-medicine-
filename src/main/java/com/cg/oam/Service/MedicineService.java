...
public class MedicineService {
	 ...
	 * medicines.stream().forEach(med->beanMedList.add(MedicineHelper.
	 * generateMedicineBean(med))); if(beanMedList.isEmpty()) { throw new
	 * EmptyResultDataAccessException(); } return beanMedList; } //method to find
	 */
